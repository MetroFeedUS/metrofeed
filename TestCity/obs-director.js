...
(function () {
    ...
    return new Promise(function (resolve) {
      ...
      const tick = function () {
        ...
        if (
          ...
          window.ROUTES &&
          window.ROUTES[getCityIdFromPath()] &&
          lazyReady
        ) {
  ...
  function buildRouteQueueFromLazyIndex() {
    ...
    const busRoutes =
      (window.ROUTES && window.ROUTES[getCityIdFromPath()] && window.ROUTES[getCityIdFromPath()].busRoutes) || [];
  ...
  function buildRouteQueue() {
    ...
    const routes = (window.ROUTES && window.ROUTES[getCityIdFromPath()] && window.ROUTES[getCityIdFromPath()].busRoutes) || [];
    const out = [];
