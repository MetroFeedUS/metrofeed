  ...
  function loadRoutesIndex() {
    ...
    if (routesIndexScriptInjected || document.getElementById(ROUTES_INDEX_SCRIPT_ID)) {
      const msg =
        ...
        'Boston lazy-loading requires: window.routesIndex = { version, routes: [...] }. ' +
        'If your file uses const ROUTES = {...} (expansion build), replace it with the Boston routes_index or fix the deploy. Hard-refresh after fixing.';
      console.error(msg);
