...
// MBTA realtime (protobuf helpers, TripUpdates, V3): mbtaRealtime.js (Phase 1)
const RT = window.MBTARealtime;
if (!RT) {
  console.error("[routeOverlay] MBTARealtime missing — load mbtaRealtime.js before routeOverlay.js");
}
const parseVarint = RT && RT.parseVarint;
const readString = RT && RT.readString;
const readFloat = RT && RT.readFloat;
const skipField = RT && RT.skipField;
const parseMBTAGTFSTripUpdates = RT && RT.parseMBTAGTFSTripUpdates;
const fetchMBTAV3Predictions = RT && RT.fetchMBTAV3Predictions;
const fetchMBTAV3Vehicles = RT && RT.fetchMBTAV3Vehicles;
const fetchMBTAV3VehiclesFallback = RT && RT.fetchMBTAV3VehiclesFallback;
